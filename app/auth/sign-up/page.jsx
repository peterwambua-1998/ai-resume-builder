import loginImg from '../../images/login-u.svg'
                    ...
                    <div className="md:grid md:grid-cols-2 md:gap-4 sm:grid-cols-1 my-bg">
                        <div>
                            ...
                            <form action="">
                                ...
                                <button type="button" class="py-3 px-4  gap-x-2 text-sm font-semibold rounded-full border border-transparent bg-[#F59E0B] text-white hover:bg-[#b78734] disabled:opacity-50 disabled:pointer-events-none w-[70%] text-center">
                                    Button
                                </button>
